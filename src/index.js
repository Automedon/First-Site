		...
		return (
			<Slider {...settings}>
				<div className="col-12">
					...
					<div className="text-center">Lorem ipsum dolor sit amet, consectetur adipisicing elit. At debitis error in,
						nulla omnis pariatur perspiciatis soluta tenetur! Facilis, inventore.
					</div>
				</div>
				<div className="col-12">
					<img src={require("./icons/cat1.jpg")} alt="" className="img-fluid rounded mx-auto d-block"/>
					<div className="text-center">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis consectetur
						in molestiae neque quia unde?
					</div>
				</div>
				<div className="col-12">
